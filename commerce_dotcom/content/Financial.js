	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'description',
				_1: _elm_lang$core$Json_Encode$string(item.description)
			},
			_1: {
				ctor: '::',
				_0: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'unitPrice',
						_1: _elm_lang$core$Json_Encode$float(item.unitPrice.price)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$PlaceOrderModel$encodePurchaseOrder = function (purchaseOrder) {
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'shipTo',
				_1: _elm_lang$core$Json_Encode$string(model.shipTo)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'itemizedPurchaseOrder',
					_1: _user$project$PlaceOrderModel$encodePurchaseOrder(model.itemizedPurchaseOrder)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$PlaceOrderModel$Model = F3(
	function (a, b, c) {
		return {itemizedPurchaseOrder: a, paymentMethod: b, shipTo: c};
	});
var _user$project$PlaceOrderModel$OrderItem = F3(
	function (a, b, c) {
		return {description: a, quantity: b, unitPrice: c};
	});
var _user$project$PlaceOrderModel$UnitPrice = F2(
	function (a, b) {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(financialData.productDescription),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(financialData.unitsSold)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Financial$viewFinancials = function (indexedFinancialData) {
	var rows = A2(
		_elm_lang$core$List$map,
		_user$project$Financial$toFinancialRow,
		_elm_lang$core$Dict$values(indexedFinancialData));
	return A2(
						...
						{ctor: '[]'},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('units sold'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('total profit'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
		...
		switch (_p0.ctor) {
			...
			case 'NewFinancialData':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{indexedFinancials: updatedFinancials}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Financial$NewFinancialData = function (a) {
	return {ctor: 'NewFinancialData', _0: a};
};
var _user$project$Financial$toFinancialDataMsg = F2(
	function (profitMargin, itemizedOrder) {
		var indexedData = _user$project$Financial$indexData(
			A2(
				_elm_lang$core$List$map,
				_user$project$Financial$toFinancialData(profitMargin),
				itemizedOrder));
		return _user$project$Financial$NewFinancialData(indexedData);
	});
...
var _user$project$Financial$SetProfitMargin = function (a) {
	return {ctor: 'SetProfitMargin', _0: a};
};
var _user$project$Financial$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Commerce.com Financial Data'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Financial$SetProfitMargin(5)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Financial$SetProfitMargin(10)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Financial$SetProfitMargin(15)),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('15%'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
							...
							_0: _user$project$PlaceOrderView$outputColumn(
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(model.profitMargin),
												'% profit margin on each item we sell.'))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
					...
					_0: _user$project$PlaceOrderView$quadrantRow(
						{
							...
							_0: A2(
								...
								},
								{
									...
									_1: {
										ctor: '::',
										_0: _user$project$Financial$viewFinancials(model.indexedFinancials),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
...
var _user$project$Financial$main = _elm_lang$html$Html$program(
	{init: _user$project$Financial$init, view: _user$project$Financial$view, update: _user$project$Financial$update, subscriptions: _user$project$Financial$subscriptions})();

var Elm = {};
Elm['Financial'] = Elm['Financial'] || {};
if (typeof _user$project$Financial$main !== 'undefined') {
    _user$project$Financial$main(Elm['Financial'], 'Financial', undefined);
}
