...
var _user$project$Shipping_Order$determineStatus = function (countdown) {
	return (_elm_lang$core$Native_Utils.cmp(countdown, 0) < 1) ? 'Delivered!' : A2(
...
var _user$project$Shipping_Order$updateStatuses = function (orders) {
	var updateStatus = function (singleOrder) {
		return _elm_lang$core$Native_Utils.update(
			singleOrder,
			{
				status: _user$project$Shipping_Order$determineStatus(singleOrder.deliveryCountdown)
			});
	};
...
var _user$project$Shipping_Order$updateOrders = function (orders) {
	return _user$project$Shipping_Order$updateStatuses(
		_user$project$Shipping_Order$decrementCountdowns(orders));
};
var _user$project$Shipping_Order$Order = F4(
	function (a, b, c, d) {
		return {id: a, shipTo: b, status: c, deliveryCountdown: d};
	});
var _user$project$Shipping_Order$decodeOrders = F2(
	function (deliveryCountdown, stringData) {
		var mapToOrder = F2(
			function (id, shipTo) {
				return A4(
					_user$project$Shipping_Order$Order,
					id,
					shipTo,
					_user$project$Shipping_Order$determineStatus(deliveryCountdown),
					deliveryCountdown);
			});
		var shipToDecoder = A2(_elm_lang$core$Json_Decode$field, 'shipTo', _elm_lang$core$Json_Decode$string);
		var idDecoder = A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string);
		var ordersDecoder = _elm_lang$core$Json_Decode$list(
			A3(_elm_lang$core$Json_Decode$map2, mapToOrder, idDecoder, shipToDecoder));
		return A2(_elm_lang$core$Json_Decode$decodeString, ordersDecoder, stringData);
	});

var _user$project$Shipping_View$toRows = function (orders) {
	var makeRow = function (singleOrder) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(singleOrder.id),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(singleOrder.shipTo),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(singleOrder.status),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
	...
	return A2(_elm_lang$core$List$map, makeRow, orders);
};
var _user$project$Shipping_View$ordersTable = function (orders) {
	return A2(
					...
					},
					{
									...
									{ctor: '[]'},
									{
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('delivering to'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								_user$project$Shipping_View$toRows(orders)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Shipping_View$Order = F4(
	function (a, b, c, d) {
		return {id: a, shipTo: b, status: c, deliveryCountdown: d};
	});
...
var _user$project$ShipOrder$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'OrdersShipped':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							orders: A2(_elm_lang$core$List$append, model.orders, _p0._0)
						}),
			...
			case 'SetSecondsToDeliver':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{secondsToDeliver: _p0._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$ShipOrder$Model = F2(
	function (a, b) {
		return {orders: a, secondsToDeliver: b};
	});
var _user$project$ShipOrder$init = {
	ctor: '_Tuple2',
	_0: A2(
		_user$project$ShipOrder$Model,
		{ctor: '[]'},
		5),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$ShipOrder$Nevermind = {ctor: 'Nevermind'};
var _user$project$ShipOrder$SetSecondsToDeliver = function (a) {
	return {ctor: 'SetSecondsToDeliver', _0: a};
};
var _user$project$ShipOrder$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Order Delivery'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$ShipOrder$SetSecondsToDeliver(5)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$ShipOrder$SetSecondsToDeliver(10)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
									...
									_1: {
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$ShipOrder$SetSecondsToDeliver(60)),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('60 seconds'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
								...
								},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(model.secondsToDeliver),
												' seconds to deliver an order.'))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Shipping_View$ordersTable(model.orders),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$ShipOrder$UpdateCountdowns = {ctor: 'UpdateCountdowns'};
var _user$project$ShipOrder$OrdersShipped = function (a) {
	return {ctor: 'OrdersShipped', _0: a};
};
var _user$project$ShipOrder$socketDataToMsg = F2(
	function (secondsToDeliver, socketData) {
		var toMsg = function (decodeResult) {
			var _p1 = decodeResult;
			if (_p1.ctor === 'Ok') {
				return _user$project$ShipOrder$OrdersShipped(_p1._0);
			} else {
				return A2(_elm_lang$core$Debug$log, _p1._0, _user$project$ShipOrder$Nevermind);
			}
		};
		return toMsg(
			A2(_user$project$Shipping_Order$decodeOrders, secondsToDeliver, socketData));
	});
var _user$project$ShipOrder$subscriptions = function (model) {
	var timerSubscription = A2(
		_elm_lang$core$Time$every,
		_elm_lang$core$Time$second,
		function (time) {
			return _user$project$ShipOrder$UpdateCountdowns;
		});
	var socketSubscription = A2(
		_elm_lang$websocket$WebSocket$listen,
		'ws://localhost:7777/shipping',
		_user$project$ShipOrder$socketDataToMsg(model.secondsToDeliver));
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: socketSubscription,
			_1: {
				ctor: '::',
				_0: timerSubscription,
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$ShipOrder$main = _elm_lang$html$Html$program(
	{init: _user$project$ShipOrder$init, view: _user$project$ShipOrder$view, update: _user$project$ShipOrder$update, subscriptions: _user$project$ShipOrder$subscriptions})();

var Elm = {};
Elm['ShipOrder'] = Elm['ShipOrder'] || {};
if (typeof _user$project$ShipOrder$main !== 'undefined') {
    _user$project$ShipOrder$main(Elm['ShipOrder'], 'ShipOrder', undefined);
}
