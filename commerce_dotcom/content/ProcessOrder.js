...
var Elm = {};
Elm['ProcessOrder'] = Elm['ProcessOrder'] || {};
if (typeof _user$project$ProcessOrder$main !== 'undefined') {
    _user$project$ProcessOrder$main(Elm['ProcessOrder'], 'ProcessOrder', undefined);
}
