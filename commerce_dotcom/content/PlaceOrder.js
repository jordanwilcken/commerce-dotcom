...
var _user$project$PlaceOrder$toRequestBody = function (model) {
	return _elm_lang$http$Http$jsonBody(
		_user$project$PlaceOrderModel$asJsonValue(model));
};
...
var _user$project$PlaceOrder$init = {
	ctor: '_Tuple2',
	_0: A3(
		_user$project$PlaceOrderModel$Model,
		{ctor: '[]'},
		'',
		''),
...
var _user$project$PlaceOrder$postAnOrder = function (model) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$PlaceOrder$OrderPosted,
		A3(
			_elm_lang$http$Http$post,
			'../orders',
			_user$project$PlaceOrder$toRequestBody(model),
			_user$project$PlaceOrder$decodeResponseMessage));
};
...
var _user$project$PlaceOrder$main = _elm_lang$html$Html$program(
	{init: _user$project$PlaceOrder$init, view: _user$project$PlaceOrder$view, update: _user$project$PlaceOrder$update, subscriptions: _user$project$PlaceOrder$subscriptions})();

var Elm = {};
Elm['PlaceOrder'] = Elm['PlaceOrder'] || {};
if (typeof _user$project$PlaceOrder$main !== 'undefined') {
    _user$project$PlaceOrder$main(Elm['PlaceOrder'], 'PlaceOrder', undefined);
}
